...
export function PercentGame() {
  ...
  if (!nivel) {
    return (
      <div className="flex min-h-[100dvh] flex-col overflow-x-hidden bg-gradient-to-b from-sky-50 via-white to-teal-50/70 pb-[max(0.75rem,env(safe-area-inset-bottom))]">
